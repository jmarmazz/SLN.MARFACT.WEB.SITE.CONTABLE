...
$(document).ready(function () {
    ...
    $('#tblAddProducto tbody').on('click', 'a', function () {
        ...
        if ($("#cboCodigoModificacion").val() == 2) // CorreccionTexto: 2
            monto = 0.00;
        ...
        tblProducto.row.add([
            ...
            '<input type="hidden" class="csshidPrecioUnitarioItem" id="hidPrecioUnitarioItem_' + j + '" name="DetallesItems[' + j + '].PrecioUnitarioItem" value="' + precioUnit + '"/>' +
    ...
    $('#cboCodigoModificacion').on('change', function () {
        // Para CorreccionTexto el monto debe ser 0
        if (this.value == 2) {
            if (($("#hidMontoTotal").val() || 0) > 0) {
                swal({
                    title: "",
                    text: "<b>El comprobante debe tener un monto total igual a cero, presione aceptar para encerar los valores</b>",
                    type: "warning",
                    ...
                    function (isConfirm) {
                        if (isConfirm) {
                            $(".cssMontoItem").html("0.00");
                            $(".csshidMontoItem").val(0.00);
                            $(".csshidPrecioUnitarioItem").val(0.00);
                            CalcularTotales();
                        }
                        else {
                            $('#cboCodigoModificacion').val(null).change();
                        }
                    });
            }
        }
