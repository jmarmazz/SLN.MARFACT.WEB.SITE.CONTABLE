using MARFACT.WEB.SITE.CONTABLE.Models.Facturacion;
using MF.TOOLS;
...
namespace MARFACT.WEB.SITE.CONTABLE.Controllers
{
    public class FacturaController : Controller
    {
        public IActionResult Index()
        {
            ...
            var secuencia = 123;//secuencialAppService.ConsultarSecuencialDocumentoXCompania(loginDto.RncCiaNube, (byte)TiposDocumentoDGII.FacturaCreditoFiscal, ref mensaje);
