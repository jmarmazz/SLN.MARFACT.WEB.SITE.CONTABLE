...
namespace MF.TOOLS
{
    public static class MFConversions
    {
        ...
        public static string ExceptionToString(System.Exception Value)
        {
            try
            {
                ...
                msg = MFUtilities.QuitarSaltosLinea(msg, " ");
                return msg;
            }
            catch (System.Exception)
            {
        ...
        {
            string Formato = "##0";
            int NumDecimales = MFUtilities.ContarDecimales(Value);
        ...
        public static System.Exception StringToException(string excepcion)
        {
            ...
            if (excepcion.Contains("ERUSER:"))
            {
                ...
                return new MFUserException(excepcion);
            }
            else
            {
                excepcion = excepcion.Replace("ERMARFACT:", null);
                return new System.Exception(excepcion);
            }
        }

        public static string DecimalToStringSimboloMiles(decimal Value, int NumDecimales = 2)
        {
            string Formato = "##0.00";
            switch (NumDecimales)
            {
                case 1: { Formato = "{0:#,##0.0}"; break; }
                case 2: { Formato = "{0:#,##0.00}"; break; }
                case 3: { Formato = "{0:#,##0.000}"; break; }
                case 4: { Formato = "{0:#,##0.0000}"; break; }
                case 5: { Formato = "{0:#,##0.00000}"; break; }
                case 6: { Formato = "{0:#,##0.000000}"; break; }
            }
            var valor = String.Format(Formato, Value);
            return valor;
        }
    }
}
